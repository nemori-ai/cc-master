...
assert_contains "$HOOK_OUT" '"additional_context"' "throttle -> additional_context"
assert_not_contains "$HOOK_OUT" '"systemMessage"' "throttle -> not systemMessage"
...
assert_contains "$HOOK_OUT" '"additional_context"' "stop_billing_period -> additional_context"
