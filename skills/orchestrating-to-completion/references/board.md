...
justification / output_schema / dep_pins / notes / log` —— 外加示例字段 `verified`、`blocked_on`，以及 top-level 的 `meta`（含 `meta.template_version`）、`wip_limit`、`wakeup`、`num_account`。
