...
│   │   ├── knowledge/        ← skill knowledge graph authored source root；K2 = 8 skills / full portfolio inventory，`compile` 投影到 `plugin/dist/<host>/knowledge/`，能力以 `skill-knowledge contract` 为准
