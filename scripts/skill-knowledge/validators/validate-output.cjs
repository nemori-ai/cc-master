 ...
 * Source-schema-sha256: a1944ba5fb6d6da72da02616dd266134fc59ccdc4b55328a7b7f046dea9b5d87
 * Schema-fingerprint: 520f87d5965552feabe532e78c8deefcc08aeccf659a2135813512f53608ba42
...
function validate20(data, { instancePath = "", parentData, parentDataProperty, rootData = data, dynamicAnchors = {} } = {}) {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (data63 && typeof data63 == "object" && !Array.isArray(data63)) {
        ...
        if (data63.C9 !== void 0) {
          ...
          if (data88 && typeof data88 == "object" && !Array.isArray(data88)) {
            ...
            if (data88.worker_allowlist === void 0) {
              const err235 = { instancePath: instancePath + "/hardening_contract/C9", schemaPath: "#/$defs/hardeningContract/properties/C9/required", keyword: "required", params: { missingProperty: "worker_allowlist" }, message: "must have required property 'worker_allowlist'" };
              if (vErrors === null) {
                vErrors = [err235];
              } else {
                vErrors.push(err235);
            ...
            if (data88.payload_modes === void 0) {
              const err236 = { instancePath: instancePath + "/hardening_contract/C9", schemaPath: "#/$defs/hardeningContract/properties/C9/required", keyword: "required", params: { missingProperty: "payload_modes" }, message: "must have required property 'payload_modes'" };
              if (vErrors === null) {
                vErrors = [err236];
              } else {
                vErrors.push(err236);
            ...
            if (data88.anchor_form === void 0) {
              const err237 = { instancePath: instancePath + "/hardening_contract/C9", schemaPath: "#/$defs/hardeningContract/properties/C9/required", keyword: "required", params: { missingProperty: "anchor_form" }, message: "must have required property 'anchor_form'" };
              if (vErrors === null) {
                vErrors = [err237];
              } else {
                vErrors.push(err237);
            ...
            if (data88.path_policy === void 0) {
              const err238 = { instancePath: instancePath + "/hardening_contract/C9", schemaPath: "#/$defs/hardeningContract/properties/C9/required", keyword: "required", params: { missingProperty: "path_policy" }, message: "must have required property 'path_policy'" };
              if (vErrors === null) {
                vErrors = [err238];
              } else {
                vErrors.push(err238);
            ...
            for (const key14 in data88) {
              if (!(key14 === "hosts" || key14 === "worker_allowlist" || key14 === "payload_modes" || key14 === "anchor_form" || key14 === "path_policy")) {
                const err239 = { instancePath: instancePath + "/hardening_contract/C9", schemaPath: "#/$defs/hardeningContract/properties/C9/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key14 }, message: "must NOT have additional properties" };
                if (vErrors === null) {
                  vErrors = [err239];
                } else {
                  vErrors.push(err239);
            ...
            if (data88.hosts !== void 0) {
              if (!func0(data88.hosts, schema46.properties.C9.properties.hosts.const)) {
                const err240 = { instancePath: instancePath + "/hardening_contract/C9/hosts", schemaPath: "#/$defs/hardeningContract/properties/C9/properties/hosts/const", keyword: "const", params: { allowedValue: schema46.properties.C9.properties.hosts.const }, message: "must be equal to constant" };
                if (vErrors === null) {
                  vErrors = [err240];
                } else {
                  vErrors.push(err240);
            ...
            if (data88.worker_allowlist !== void 0) {
              if (!func0(data88.worker_allowlist, schema46.properties.C9.properties.worker_allowlist.const)) {
                const err241 = { instancePath: instancePath + "/hardening_contract/C9/worker_allowlist", schemaPath: "#/$defs/hardeningContract/properties/C9/properties/worker_allowlist/const", keyword: "const", params: { allowedValue: schema46.properties.C9.properties.worker_allowlist.const }, message: "must be equal to constant" };
                if (vErrors === null) {
                  vErrors = [err241];
                } else {
                  vErrors.push(err241);
            ...
            if (data88.payload_modes !== void 0) {
              if (!func0(data88.payload_modes, schema46.properties.C9.properties.payload_modes.const)) {
                const err242 = { instancePath: instancePath + "/hardening_contract/C9/payload_modes", schemaPath: "#/$defs/hardeningContract/properties/C9/properties/payload_modes/const", keyword: "const", params: { allowedValue: schema46.properties.C9.properties.payload_modes.const }, message: "must be equal to constant" };
                if (vErrors === null) {
                  vErrors = [err242];
                } else {
                  vErrors.push(err242);
            ...
            if (data88.anchor_form !== void 0) {
              if ("explicit-html-id" !== data88.anchor_form) {
                const err243 = { instancePath: instancePath + "/hardening_contract/C9/anchor_form", schemaPath: "#/$defs/hardeningContract/properties/C9/properties/anchor_form/const", keyword: "const", params: { allowedValue: "explicit-html-id" }, message: "must be equal to constant" };
                if (vErrors === null) {
                  vErrors = [err243];
                } else {
                  vErrors.push(err243);
            ...
            if (data88.path_policy !== void 0) {
              if ("relative-final-host-path" !== data88.path_policy) {
                const err244 = { instancePath: instancePath + "/hardening_contract/C9/path_policy", schemaPath: "#/$defs/hardeningContract/properties/C9/properties/path_policy/const", keyword: "const", params: { allowedValue: "relative-final-host-path" }, message: "must be equal to constant" };
                if (vErrors === null) {
                  vErrors = [err244];
                } else {
                  vErrors.push(err244);
            ...
            const err245 = { instancePath: instancePath + "/hardening_contract/C9", schemaPath: "#/$defs/hardeningContract/properties/C9/type", keyword: "type", params: { type: "object" }, message: "must be object" };
            if (vErrors === null) {
              vErrors = [err245];
            } else {
              vErrors.push(err245);
        ...
        if (data63.C10 !== void 0) {
          let data94 = data63.C10;
          if (data94 && typeof data94 == "object" && !Array.isArray(data94)) {
            if (data94.changed_scope_base_option === void 0) {
              const err246 = { instancePath: instancePath + "/hardening_contract/C10", schemaPath: "#/$defs/hardeningContract/properties/C10/required", keyword: "required", params: { missingProperty: "changed_scope_base_option" }, message: "must have required property 'changed_scope_base_option'" };
              if (vErrors === null) {
                vErrors = [err246];
              } else {
                vErrors.push(err246);
            ...
            if (data94.immutable_chain === void 0) {
              const err247 = { instancePath: instancePath + "/hardening_contract/C10", schemaPath: "#/$defs/hardeningContract/properties/C10/required", keyword: "required", params: { missingProperty: "immutable_chain" }, message: "must have required property 'immutable_chain'" };
              if (vErrors === null) {
                vErrors = [err247];
              } else {
                vErrors.push(err247);
            ...
            for (const key15 in data94) {
              if (!(key15 === "changed_scope_base_option" || key15 === "immutable_chain")) {
                const err248 = { instancePath: instancePath + "/hardening_contract/C10", schemaPath: "#/$defs/hardeningContract/properties/C10/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key15 }, message: "must NOT have additional properties" };
                if (vErrors === null) {
                  vErrors = [err248];
                } else {
                  vErrors.push(err248);
            ...
            if (data94.changed_scope_base_option !== void 0) {
              if ("--base" !== data94.changed_scope_base_option) {
                const err249 = { instancePath: instancePath + "/hardening_contract/C10/changed_scope_base_option", schemaPath: "#/$defs/hardeningContract/properties/C10/properties/changed_scope_base_option/const", keyword: "const", params: { allowedValue: "--base" }, message: "must be equal to constant" };
                if (vErrors === null) {
                  vErrors = [err249];
                } else {
                  vErrors.push(err249);
            ...
            if (data94.immutable_chain !== void 0) {
              if (true !== data94.immutable_chain) {
                const err250 = { instancePath: instancePath + "/hardening_contract/C10/immutable_chain", schemaPath: "#/$defs/hardeningContract/properties/C10/properties/immutable_chain/const", keyword: "const", params: { allowedValue: true }, message: "must be equal to constant" };
                if (vErrors === null) {
                  vErrors = [err250];
                } else {
                  vErrors.push(err250);
            ...
            const err251 = { instancePath: instancePath + "/hardening_contract/C10", schemaPath: "#/$defs/hardeningContract/properties/C10/type", keyword: "type", params: { type: "object" }, message: "must be object" };
            if (vErrors === null) {
              vErrors = [err251];
            } else {
              vErrors.push(err251);
        ...
        if (data63.C11 !== void 0) {
          let data97 = data63.C11;
          if (data97 && typeof data97 == "object" && !Array.isArray(data97)) {
            if (data97.k2_allows_partial === void 0) {
              const err252 = { instancePath: instancePath + "/hardening_contract/C11", schemaPath: "#/$defs/hardeningContract/properties/C11/required", keyword: "required", params: { missingProperty: "k2_allows_partial" }, message: "must have required property 'k2_allows_partial'" };
              if (vErrors === null) {
                vErrors = [err252];
              } else {
                vErrors.push(err252);
            ...
            for (const key16 in data97) {
              if (!(key16 === "k2_allows_partial")) {
                const err253 = { instancePath: instancePath + "/hardening_contract/C11", schemaPath: "#/$defs/hardeningContract/properties/C11/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key16 }, message: "must NOT have additional properties" };
                if (vErrors === null) {
                  vErrors = [err253];
                } else {
                  vErrors.push(err253);
            ...
            if (data97.k2_allows_partial !== void 0) {
              if (false !== data97.k2_allows_partial) {
                const err254 = { instancePath: instancePath + "/hardening_contract/C11/k2_allows_partial", schemaPath: "#/$defs/hardeningContract/properties/C11/properties/k2_allows_partial/const", keyword: "const", params: { allowedValue: false }, message: "must be equal to constant" };
                if (vErrors === null) {
                  vErrors = [err254];
                } else {
                  vErrors.push(err254);
            ...
            const err255 = { instancePath: instancePath + "/hardening_contract/C11", schemaPath: "#/$defs/hardeningContract/properties/C11/type", keyword: "type", params: { type: "object" }, message: "must be object" };
            if (vErrors === null) {
              vErrors = [err255];
            } else {
              vErrors.push(err255);
        ...
        if (data63.C12 !== void 0) {
          let data99 = data63.C12;
          if (data99 && typeof data99 == "object" && !Array.isArray(data99)) {
            if (data99.report_tracks === void 0) {
              const err256 = { instancePath: instancePath + "/hardening_contract/C12", schemaPath: "#/$defs/hardeningContract/properties/C12/required", keyword: "required", params: { missingProperty: "report_tracks" }, message: "must have required property 'report_tracks'" };
              if (vErrors === null) {
                vErrors = [err256];
              } else {
                vErrors.push(err256);
            ...
            for (const key17 in data99) {
              if (!(key17 === "report_tracks")) {
                const err257 = { instancePath: instancePath + "/hardening_contract/C12", schemaPath: "#/$defs/hardeningContract/properties/C12/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key17 }, message: "must NOT have additional properties" };
                if (vErrors === null) {
                  vErrors = [err257];
                } else {
                  vErrors.push(err257);
            ...
            if (data99.report_tracks !== void 0) {
              if (!func0(data99.report_tracks, schema46.properties.C12.properties.report_tracks.const)) {
                const err258 = { instancePath: instancePath + "/hardening_contract/C12/report_tracks", schemaPath: "#/$defs/hardeningContract/properties/C12/properties/report_tracks/const", keyword: "const", params: { allowedValue: schema46.properties.C12.properties.report_tracks.const }, message: "must be equal to constant" };
                if (vErrors === null) {
                  vErrors = [err258];
                } else {
                  vErrors.push(err258);
            ...
            const err259 = { instancePath: instancePath + "/hardening_contract/C12", schemaPath: "#/$defs/hardeningContract/properties/C12/type", keyword: "type", params: { type: "object" }, message: "must be object" };
            if (vErrors === null) {
              vErrors = [err259];
            } else {
              vErrors.push(err259);
        ...
        if (data63.C13 !== void 0) {
          let data101 = data63.C13;
          if (data101 && typeof data101 == "object" && !Array.isArray(data101)) {
            if (data101.research_supersession_required === void 0) {
              const err260 = { instancePath: instancePath + "/hardening_contract/C13", schemaPath: "#/$defs/hardeningContract/properties/C13/required", keyword: "required", params: { missingProperty: "research_supersession_required" }, message: "must have required property 'research_supersession_required'" };
              if (vErrors === null) {
                vErrors = [err260];
              } else {
                vErrors.push(err260);
            ...
            for (const key18 in data101) {
              if (!(key18 === "research_supersession_required")) {
                const err261 = { instancePath: instancePath + "/hardening_contract/C13", schemaPath: "#/$defs/hardeningContract/properties/C13/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key18 }, message: "must NOT have additional properties" };
                if (vErrors === null) {
                  vErrors = [err261];
                } else {
                  vErrors.push(err261);
            ...
            if (data101.research_supersession_required !== void 0) {
              if (true !== data101.research_supersession_required) {
                const err262 = { instancePath: instancePath + "/hardening_contract/C13/research_supersession_required", schemaPath: "#/$defs/hardeningContract/properties/C13/properties/research_supersession_required/const", keyword: "const", params: { allowedValue: true }, message: "must be equal to constant" };
                if (vErrors === null) {
                  vErrors = [err262];
                } else {
                  vErrors.push(err262);
            ...
            const err263 = { instancePath: instancePath + "/hardening_contract/C13", schemaPath: "#/$defs/hardeningContract/properties/C13/type", keyword: "type", params: { type: "object" }, message: "must be object" };
            if (vErrors === null) {
              vErrors = [err263];
            } else {
              vErrors.push(err263);
        ...
        if (data63.C14 !== void 0) {
          let data103 = data63.C14;
          if (data103 && typeof data103 == "object" && !Array.isArray(data103)) {
            if (data103.runtime_skill_count === void 0) {
              const err264 = { instancePath: instancePath + "/hardening_contract/C14", schemaPath: "#/$defs/hardeningContract/properties/C14/required", keyword: "required", params: { missingProperty: "runtime_skill_count" }, message: "must have required property 'runtime_skill_count'" };
              if (vErrors === null) {
                vErrors = [err264];
              } else {
                vErrors.push(err264);
            ...
            if (data103.governance_meta_skill_is_runtime === void 0) {
              const err265 = { instancePath: instancePath + "/hardening_contract/C14", schemaPath: "#/$defs/hardeningContract/properties/C14/required", keyword: "required", params: { missingProperty: "governance_meta_skill_is_runtime" }, message: "must have required property 'governance_meta_skill_is_runtime'" };
              if (vErrors === null) {
                vErrors = [err265];
              } else {
                vErrors.push(err265);
            ...
            for (const key19 in data103) {
              if (!(key19 === "runtime_skill_count" || key19 === "governance_meta_skill_is_runtime")) {
                const err266 = { instancePath: instancePath + "/hardening_contract/C14", schemaPath: "#/$defs/hardeningContract/properties/C14/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key19 }, message: "must NOT have additional properties" };
                if (vErrors === null) {
                  vErrors = [err266];
                } else {
                  vErrors.push(err266);
            ...
            if (data103.runtime_skill_count !== void 0) {
              if (8 !== data103.runtime_skill_count) {
                const err267 = { instancePath: instancePath + "/hardening_contract/C14/runtime_skill_count", schemaPath: "#/$defs/hardeningContract/properties/C14/properties/runtime_skill_count/const", keyword: "const", params: { allowedValue: 8 }, message: "must be equal to constant" };
                if (vErrors === null) {
                  vErrors = [err267];
                } else {
                  vErrors.push(err267);
            ...
            if (data103.governance_meta_skill_is_runtime !== void 0) {
              if (false !== data103.governance_meta_skill_is_runtime) {
                const err268 = { instancePath: instancePath + "/hardening_contract/C14/governance_meta_skill_is_runtime", schemaPath: "#/$defs/hardeningContract/properties/C14/properties/governance_meta_skill_is_runtime/const", keyword: "const", params: { allowedValue: false }, message: "must be equal to constant" };
                if (vErrors === null) {
                  vErrors = [err268];
                } else {
                  vErrors.push(err268);
            ...
            const err269 = { instancePath: instancePath + "/hardening_contract/C14", schemaPath: "#/$defs/hardeningContract/properties/C14/type", keyword: "type", params: { type: "object" }, message: "must be object" };
            if (vErrors === null) {
              vErrors = [err269];
            } else {
              vErrors.push(err269);
        ...
        const err270 = { instancePath: instancePath + "/hardening_contract", schemaPath: "#/$defs/hardeningContract/type", keyword: "type", params: { type: "object" }, message: "must be object" };
        if (vErrors === null) {
          vErrors = [err270];
        } else {
          vErrors.push(err270);
    ...
    if (data.structural_status !== void 0) {
      let data106 = data.structural_status;
      if (data106 && typeof data106 == "object" && !Array.isArray(data106)) {
        if (data106.state === void 0) {
          const err271 = { instancePath: instancePath + "/structural_status", schemaPath: "#/$defs/structuralStatus/required", keyword: "required", params: { missingProperty: "state" }, message: "must have required property 'state'" };
          if (vErrors === null) {
            vErrors = [err271];
          } else {
            vErrors.push(err271);
        ...
        for (const key20 in data106) {
          if (!(key20 === "state")) {
            const err272 = { instancePath: instancePath + "/structural_status", schemaPath: "#/$defs/structuralStatus/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key20 }, message: "must NOT have additional properties" };
            if (vErrors === null) {
              vErrors = [err272];
            } else {
              vErrors.push(err272);
        ...
        if (data106.state !== void 0) {
          let data107 = data106.state;
          if (!(data107 === "pass" || data107 === "fail" || data107 === "debt" || data107 === "not_run")) {
            const err273 = { instancePath: instancePath + "/structural_status/state", schemaPath: "#/$defs/structuralStatus/properties/state/enum", keyword: "enum", params: { allowedValues: schema47.properties.state.enum }, message: "must be equal to one of the allowed values" };
            if (vErrors === null) {
              vErrors = [err273];
            } else {
              vErrors.push(err273);
        ...
        const err274 = { instancePath: instancePath + "/structural_status", schemaPath: "#/$defs/structuralStatus/type", keyword: "type", params: { type: "object" }, message: "must be object" };
        if (vErrors === null) {
          vErrors = [err274];
        } else {
          vErrors.push(err274);
    ...
    if (data.improvement_claim !== void 0) {
      let data109 = data.improvement_claim;
      if (typeof data109 === "string") {
        if (func1(data109) < 1) {
          const err275 = { instancePath: instancePath + "/improvement_claim", schemaPath: "#/properties/improvement_claim/minLength", keyword: "minLength", params: { limit: 1 }, message: "must NOT have fewer than 1 characters" };
          if (vErrors === null) {
            vErrors = [err275];
          } else {
            vErrors.push(err275);
        ...
        const err276 = { instancePath: instancePath + "/improvement_claim", schemaPath: "#/properties/improvement_claim/type", keyword: "type", params: { type: "string" }, message: "must be string" };
        if (vErrors === null) {
          vErrors = [err276];
        } else {
          vErrors.push(err276);
    ...
    if (data.diagnostics !== void 0) {
      let data110 = data.diagnostics;
      if (Array.isArray(data110)) {
        const len5 = data110.length;
        for (let i10 = 0; i10 < len5; i10++) {
          let data111 = data110[i10];
          if (data111 && typeof data111 == "object" && !Array.isArray(data111)) {
            if (data111.severity === void 0) {
              const err277 = { instancePath: instancePath + "/diagnostics/" + i10, schemaPath: "#/$defs/diagnostic/required", keyword: "required", params: { missingProperty: "severity" }, message: "must have required property 'severity'" };
              if (vErrors === null) {
                vErrors = [err277];
              } else {
                vErrors.push(err277);
            ...
            if (data111.code === void 0) {
              const err278 = { instancePath: instancePath + "/diagnostics/" + i10, schemaPath: "#/$defs/diagnostic/required", keyword: "required", params: { missingProperty: "code" }, message: "must have required property 'code'" };
              if (vErrors === null) {
                vErrors = [err278];
              } else {
                vErrors.push(err278);
            ...
            if (data111.message === void 0) {
              const err279 = { instancePath: instancePath + "/diagnostics/" + i10, schemaPath: "#/$defs/diagnostic/required", keyword: "required", params: { missingProperty: "message" }, message: "must have required property 'message'" };
              if (vErrors === null) {
                vErrors = [err279];
              } else {
                vErrors.push(err279);
            ...
            if (data111.location === void 0) {
              const err280 = { instancePath: instancePath + "/diagnostics/" + i10, schemaPath: "#/$defs/diagnostic/required", keyword: "required", params: { missingProperty: "location" }, message: "must have required property 'location'" };
              if (vErrors === null) {
                vErrors = [err280];
              } else {
                vErrors.push(err280);
            ...
            if (data111.witness === void 0) {
              const err281 = { instancePath: instancePath + "/diagnostics/" + i10, schemaPath: "#/$defs/diagnostic/required", keyword: "required", params: { missingProperty: "witness" }, message: "must have required property 'witness'" };
              if (vErrors === null) {
                vErrors = [err281];
              } else {
                vErrors.push(err281);
            ...
            if (data111.remediation === void 0) {
              const err282 = { instancePath: instancePath + "/diagnostics/" + i10, schemaPath: "#/$defs/diagnostic/required", keyword: "required", params: { missingProperty: "remediation" }, message: "must have required property 'remediation'" };
              if (vErrors === null) {
                vErrors = [err282];
              } else {
                vErrors.push(err282);
            ...
            for (const key21 in data111) {
              if (!(key21 === "severity" || key21 === "code" || key21 === "message" || key21 === "location" || key21 === "witness" || key21 === "remediation")) {
                const err283 = { instancePath: instancePath + "/diagnostics/" + i10, schemaPath: "#/$defs/diagnostic/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key21 }, message: "must NOT have additional properties" };
                if (vErrors === null) {
                  vErrors = [err283];
                } else {
                  vErrors.push(err283);
            ...
            if (data111.severity !== void 0) {
              let data112 = data111.severity;
              if (!(data112 === "error" || data112 === "warning" || data112 === "debt" || data112 === "info")) {
                const err284 = { instancePath: instancePath + "/diagnostics/" + i10 + "/severity", schemaPath: "#/$defs/diagnostic/properties/severity/enum", keyword: "enum", params: { allowedValues: schema50.properties.severity.enum }, message: "must be equal to one of the allowed values" };
                if (vErrors === null) {
                  vErrors = [err284];
                } else {
                  vErrors.push(err284);
            ...
            if (data111.code !== void 0) {
              let data113 = data111.code;
              if (typeof data113 === "string") {
                if (!pattern12.test(data113)) {
                  const err285 = { instancePath: instancePath + "/diagnostics/" + i10 + "/code", schemaPath: "#/$defs/diagnostic/properties/code/pattern", keyword: "pattern", params: { pattern: "^SKG-[A-Z0-9-]+$" }, message: 'must match pattern "^SKG-[A-Z0-9-]+$"' };
                  if (vErrors === null) {
                    vErrors = [err285];
                  } else {
                    vErrors.push(err285);
                ...
                const err286 = { instancePath: instancePath + "/diagnostics/" + i10 + "/code", schemaPath: "#/$defs/diagnostic/properties/code/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                if (vErrors === null) {
                  vErrors = [err286];
                } else {
                  vErrors.push(err286);
            ...
            if (data111.message !== void 0) {
              let data114 = data111.message;
              if (typeof data114 === "string") {
                if (func1(data114) < 1) {
                  const err287 = { instancePath: instancePath + "/diagnostics/" + i10 + "/message", schemaPath: "#/$defs/diagnostic/properties/message/minLength", keyword: "minLength", params: { limit: 1 }, message: "must NOT have fewer than 1 characters" };
                  if (vErrors === null) {
                    vErrors = [err287];
                  } else {
                    vErrors.push(err287);
                ...
                const err288 = { instancePath: instancePath + "/diagnostics/" + i10 + "/message", schemaPath: "#/$defs/diagnostic/properties/message/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                if (vErrors === null) {
                  vErrors = [err288];
                } else {
                  vErrors.push(err288);
            ...
            if (data111.location !== void 0) {
              let data115 = data111.location;
              if (typeof data115 === "string") {
                if (func1(data115) < 1) {
                  const err289 = { instancePath: instancePath + "/diagnostics/" + i10 + "/location", schemaPath: "#/$defs/diagnostic/properties/location/minLength", keyword: "minLength", params: { limit: 1 }, message: "must NOT have fewer than 1 characters" };
                  if (vErrors === null) {
                    vErrors = [err289];
                  } else {
                    vErrors.push(err289);
                ...
                const err290 = { instancePath: instancePath + "/diagnostics/" + i10 + "/location", schemaPath: "#/$defs/diagnostic/properties/location/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                if (vErrors === null) {
                  vErrors = [err290];
                } else {
                  vErrors.push(err290);
            ...
            if (data111.witness !== void 0) {
              let data116 = data111.witness;
              if (!(data116 && typeof data116 == "object" && !Array.isArray(data116))) {
                const err291 = { instancePath: instancePath + "/diagnostics/" + i10 + "/witness", schemaPath: "#/$defs/diagnostic/properties/witness/type", keyword: "type", params: { type: "object" }, message: "must be object" };
                if (vErrors === null) {
                  vErrors = [err291];
                } else {
                  vErrors.push(err291);
            ...
            if (data111.remediation !== void 0) {
              let data117 = data111.remediation;
              if (typeof data117 === "string") {
                if (func1(data117) < 1) {
                  const err292 = { instancePath: instancePath + "/diagnostics/" + i10 + "/remediation", schemaPath: "#/$defs/diagnostic/properties/remediation/minLength", keyword: "minLength", params: { limit: 1 }, message: "must NOT have fewer than 1 characters" };
                  if (vErrors === null) {
                    vErrors = [err292];
                  } else {
                    vErrors.push(err292);
                ...
                const err293 = { instancePath: instancePath + "/diagnostics/" + i10 + "/remediation", schemaPath: "#/$defs/diagnostic/properties/remediation/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                if (vErrors === null) {
                  vErrors = [err293];
                } else {
                  vErrors.push(err293);
            ...
            const err294 = { instancePath: instancePath + "/diagnostics/" + i10, schemaPath: "#/$defs/diagnostic/type", keyword: "type", params: { type: "object" }, message: "must be object" };
            if (vErrors === null) {
              vErrors = [err294];
            } else {
              vErrors.push(err294);
        ...
        const err295 = { instancePath: instancePath + "/diagnostics", schemaPath: "#/properties/diagnostics/type", keyword: "type", params: { type: "array" }, message: "must be array" };
        if (vErrors === null) {
          vErrors = [err295];
        } else {
          vErrors.push(err295);
    ...
    if (props0 !== true) {
      for (const key22 in data) {
        if (!props0 || !props0[key22]) {
          const err296 = { instancePath, schemaPath: "#/unevaluatedProperties", keyword: "unevaluatedProperties", params: { unevaluatedProperty: key22 }, message: "must NOT have unevaluated properties" };
          if (vErrors === null) {
            vErrors = [err296];
          } else {
            vErrors.push(err296);
    ...
    const err297 = { instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" }, message: "must be object" };
    if (vErrors === null) {
      vErrors = [err297];
    } else {
      vErrors.push(err297);
