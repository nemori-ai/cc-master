...
#      orchestrating-to-completion / pacing-and-estimation / using-ccm) followed by `/…` is a dead
...
const DIST_SKILL_NAMES = ['authoring-workflows', 'orchestrating-to-completion', 'pacing-and-estimation', 'using-ccm', 'slicing-goals-into-dags', 'dev-as-ml-loop', 'engineering-with-craft'];
