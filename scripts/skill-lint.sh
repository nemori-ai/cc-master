...
const DIST_SKILL_NAMES = ['authoring-workflows', 'orchestrating-to-completion', 'account-management', 'using-ccm', 'slicing-goals-into-dags', 'dev-as-ml-loop', 'engineering-with-craft'];
