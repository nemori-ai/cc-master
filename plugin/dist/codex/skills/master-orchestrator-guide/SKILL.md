...
| `dispatch.md` | 选 Codex agent runtime 可追踪后台机制（subagent / 后台 terminal / cloud task / external scheduler / automation）+ **派发卫生**；Workflow 语义当前 unsupported |
