...
// PARITY: rule-usage-pacing-codex-7d-only
...
function main() {
  ...
  lines.push('Codex pacing uses only the 7d hard ceiling plus rolling-24h advisory; 5h evidence and automatic account switching are ignored. Machine-wide fan-out remains the durable delivery authority.');
