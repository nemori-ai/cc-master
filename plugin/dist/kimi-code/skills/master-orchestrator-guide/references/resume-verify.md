...
- [next: 用户理解校验](./resume-verify.md#ccm-k-point-verification-user-understanding) <!-- ccm:k:edge edge:verification.procedure-to-understanding -->
<!-- ccm:k:nav:end -->
...
<a id="ccm-k-point-verification-user-understanding"></a>
...
<!-- ccm:k:nav:start point:verification.user-understanding -->
Knowledge navigation:
- [Knowledge atlas](../SKILL.md#ccm-k-skill-master-orchestrator-guide)
- [Module module:verification.endpoint](./worker-routing.md#ccm-k-module-verification-endpoint)
- [routes_to: 端点验收 procedure](./resume-verify.md#ccm-k-point-verification-endpoint-procedure) <!-- ccm:k:edge edge:verification.understanding-to-procedure -->
<!-- ccm:k:nav:end -->
