...
[using-ccm 主动查询合同](${CLAUDE_PLUGIN_ROOT}/skills/using-ccm/references/command-catalog.md#跨-harness-主动查询目标事实) **主动查询目标事实**，再按
[pacing-and-estimation 目标事实口径](${CLAUDE_PLUGIN_ROOT}/skills/pacing-and-estimation/references/cross-harness-target-facts.md)
