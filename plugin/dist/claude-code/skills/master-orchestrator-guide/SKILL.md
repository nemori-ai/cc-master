...
- [contrasts_with: 起草与 launch 契约](../authoring-workflows/SKILL.md#ccm-k-point-workflow-authoring-contract) <!-- ccm:k:edge edge:navigation-map-not-workflow -->
<!-- ccm:k:nav:end -->
## ④ 最高频行为 / 范式：决策程序 + 操作指导
...
- [账号切换决策锚](./references/cost-decisions.md#ccm-k-module-capacity-account-switch)
- [容量与截止期决策](./references/model-allocation.md#ccm-k-module-capacity-delivery)
- [号池概念 + account 命令面](../using-ccm/references/account-pool.md#ccm-k-module-ccm-account-pool)
...
- [Session 交接](./references/handoff.md#ccm-k-module-continuity-handoff)
...
- [Workflow Pattern 目录](../authoring-workflows/references/patterns.md#ccm-k-module-workflow-pattern-catalog)
- [Workflow Runtime/API 契约](../authoring-workflows/references/mechanism.md#ccm-k-module-workflow-runtime-contract)
- [Workflow 准入与形状选择](../authoring-workflows/SKILL.md#ccm-k-module-workflow-selection)
