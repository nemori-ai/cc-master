...
- [requires: pool 相对轴 vs usage 绝对轴](./pool-aware-advice.md#ccm-k-point-pacing-pool-vs-usage)
...
- [contrasts_with: pool 合理化表与消费顺序](./pool-aware-advice.md#ccm-k-point-pacing-pool-rationalization)
<!-- ccm:k:nav:end -->
...
- [Module module:pacing.pool](../../../knowledge/modules/pacing.pool.md#ccm-k-module-pacing-pool)
- [routes_to: 先全局再下钻](./usage-signals.md#ccm-k-point-pacing-machine-wide-first)
- [routes_to: 读 pool own_row](./pool-aware-advice.md#ccm-k-point-pacing-own-row)
<!-- ccm:k:nav:end -->
