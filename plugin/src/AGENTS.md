...
content-summary: |
  cc-master plugin source tree 入口。定义 paragoge-style source-of-truth：skills 使用 SAP，hooks 使用 PHIP，skill knowledge graph 使用独立 authored source root，dist 只由 sync 生成。
---
