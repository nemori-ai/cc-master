...
| cross-harness-session-bound-worker | [cross-harness-session-bound-worker.md](cross-harness-session-bound-worker.md) | B | `current` — four-harness session-bound raw wrapper |
