...
| cross-harness-notification-subscription | [cross-harness-notification-subscription.md](cross-harness-notification-subscription.md) | B | `target` — exact session/epoch contract |
